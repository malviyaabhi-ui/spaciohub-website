...
const BASE = 'https://svksiwnalmrjjnskycqb.supabase.co/storage/v1/object/public/Screenshot%20from%20SpasioHub'

const BOOKING_SUBSTEPS = [
  { id:'grid',  label:'Week view',           img:`${BASE}/02_BookARoom.jpg`,   orient:'landscape', badge:null },
  { id:'modal', label:'Booking form',        img:`${BASE}/booking_modal.jpg`,  orient:'portrait',  badge:null },
  { id:'ai',    label:'AI room suggestion',  img:`${BASE}/booking_modal.jpg`,  orient:'portrait',  badge:{ img:`${BASE}/ai_suggestion.jpg`, label:'AI Room Suggestion', color:'#6366f1', position:'bottom' } },
  { id:'zoom',  label:'Auto Zoom link',      img:`${BASE}/booking_modal.jpg`,  orient:'portrait',  badge:{ img:`${BASE}/zoom_feature.jpg`,  label:'Zoom Auto-Created',  color:'#2563eb', position:'top'    } },
]

const STEPS = [
  { id:'dashboard',   step:'01', label:'Dashboard',     title:'Smart Dashboard',       tag:'Dashboard',     color:'#00c07a', img:`${BASE}/01_Dashboard.jpg`,    orient:'landscape', desc:'Walk in knowing exactly which rooms are free, booked, and coming up — all at a glance.', highlights:['Active rooms & room availability','Upcoming bookings timeline','Quick stats: bookings, in-use, upcoming'], booking:false },
  { id:'booking',     step:'02', label:'Room Booking',  title:'Book in seconds',       tag:'Room Booking',  color:'#3b82f6', img:`${BASE}/02_BookARoom.jpg`,    orient:'landscape', desc:'Click any free slot on the visual grid. AI suggests the best room. Zoom link created automatically.',  highlights:['Visual week & day grid','AI room suggestion engine','Auto Zoom meeting link'], booking:true },
  { id:'roomstatus',  step:'03', label:'Door Panel',    title:'Live Room Status',      tag:'Door Panel',    color:'#10b981', img:`${BASE}/06_RoomStatus.jpg`,   orient:'portrait',  desc:'Every room shows live status on a tablet outside the door. Auto-releases if no one checks in.',    highlights:['Green / red / amber status','Quick book from the panel','Auto-release if no check-in'], booking:false },
  { id:'kiosk',       step:'04', label:'Visitor Kiosk', title:'Self-Service Check-in', tag:'Visitor Kiosk', color:'#8b5cf6', img:`${BASE}/03_VisitorKiosk.jpg`, orient:'landscape', desc:'Visitors scan a QR code or enter details at a sleek kiosk. No clipboard. Host notified instantly.', highlights:['QR code check-in','Manual entry option','Instant host notification'], booking:false },
  { id:'visitorpass', step:'05', label:'Visitor Pass',  title:'Instant Visitor Pass',  tag:'Visitor Pass',  color:'#0ea5e9', img:`${BASE}/07_VisitorPass.jpg`,  orient:'landscape', desc:'Every visitor gets a branded digital pass with their name, company, host, and a unique QR code.',   highlights:['Branded with your logo','QR code for scan check-in','Host and purpose captured'], booking:false },
  { id:'ai',          step:'06', label:'AI Booker',     title:'Mira — AI Booker',      tag:'AI Booker',     color:'#f59e0b', img:`${BASE}/05_AIBooker.jpg`,     orient:'portrait',  desc:'Tell Mira what you need in plain English. She finds the right room and books it in one conversation.', highlights:['Natural language booking','Room recommendations','Confirms and books instantly'], booking:false },
  { id:'analytics',   step:'07', label:'Analytics',     title:'Analytics & Insights',  tag:'Analytics',     color:'#ec4899', img:`${BASE}/04_Analytics.jpg`,    orient:'portrait',  desc:'See booking trends, peak hours, most used rooms. Export to CSV for your own BI tools.',           highlights:['Daily booking trend chart','Most booked rooms ranking','CSV export anytime'], booking:false },
]
